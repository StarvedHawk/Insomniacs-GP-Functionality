...
def gen():
    ...
    while True:
        ...
        if GD_Face_Number < 2:
                ...
                if MD_Face_Check:
                    ...
                    if MD_Close_time < MD_CLOSE_THRESHOLD:
                        ...
                        try:
                            ...
                            print("No Face at ",Current_Time_Stamp)
                            print("Danger Level : ",30)
                else:
                    print("No Face Detected at ",Current_Time_Stamp)
                    print("Danger Level : ", 30)
                print("-----------------------------------------------")
            else:
                break
            ...
            print("Multiple Faces Detected at ",Current_Time_Stamp)
            print("Danger Level : ", 30)

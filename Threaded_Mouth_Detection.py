...
class VideoCaptureTest(unittest.TestCase):
    ...
    def _run(self, n_frames=500, width=1280, height=720):
        ...
        landmark_detector = dlib.shape_predictor(r"C:\Users\faisa\PycharmProjects\Specula-Frontend\Insomniacs-GP-Functionality\Resources\shape_predictor_68_face_landmarks.dat")  # predictor
        ...
        # Create new threads
        thread1 = Mouth_Detection(1, "Thread-alpha", cap, Student_ID,Exam,face_detector,landmark_detector,detection_model,category_index)
    ...
    def test_video_capture_multi_threading(self):
        n_frames = 500
        self._run(n_frames, 640, 480)
